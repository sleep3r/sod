...
from attention import RFB_Block, aggregation, ObjectAttention
...
class TRACER(nn.Module):
    def __init__(self, cfg):
        ...
        self.model = EfficientNet.from_pretrained(f'efficientnet-b{cfg.arch}', advprop=True, cfg=cfg)
...
model_info = pd.DataFrame({
    ...
    "#Params": ["7.45M", "9.96M", "11.09M", "14.02M", "20.71M", "31.3M", "43.47M", "66.27M"],
